...
export default async function LandingPage() {
  try {
    ...
    // If it's a redirect, we MUST rethrow it so Next.js handles it
    if (err && err.digest && err.digest.startsWith('NEXT_REDIRECT')) {
      throw err;
    }
    
    // Surface the EXACT error trace to the UI to bypass the generic Next.js 500 error screen.
    return (
      <div style={{ padding: 40, fontFamily: "monospace", color: "red", background: "#fee" }}>
        <h1>LandingPage Server Error</h1>
