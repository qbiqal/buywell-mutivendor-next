...
const POLICY_PAGES = [
  ...
  },
  {
    ...
    content: [
      ...
      '<h2>Who We Are</h2>',
      '<p>BuyWell Marketplace operates from Bheemanpadi, Kottayam West, Kottayam, Kerala – 686003 and offers quality products across multiple categories as an Buywell Online Shopping India Pvt Ltd. For privacy, consent, grievance, and data-rights requests, contact support@buywell.in.</p>',
...
const DEFAULT_MENUS = [
  {
    ...
    items: [
      ...
      { label: 'Policies', href: '/privacy-policy', itemType: 'cms_page', policyType: 'privacy', sortOrder: 3 },
      { label: 'Terms', href: '/terms-and-conditions', itemType: 'cms_page', policyType: 'terms', parentLabel: 'Policies', sortOrder: 4 },
      { label: 'Data Protection', href: '/data-protection-consent-policy', itemType: 'cms_page', policyType: 'data_protection', parentLabel: 'Policies', sortOrder: 5 },
      { label: 'Refunds', href: '/refund-policy', itemType: 'cms_page', policyType: 'refund', parentLabel: 'Policies', sortOrder: 6 },
      { label: 'Shipping', href: '/shipping-policy', itemType: 'cms_page', policyType: 'shipping', parentLabel: 'Policies', sortOrder: 7 },
      { label: 'Contact', href: '/contact', itemType: 'landing_anchor', sortOrder: 8 },
    ],
  },
  {
    menuKey: 'site_header',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Policies', href: '/privacy-policy', itemType: 'cms_page', policyType: 'privacy', sortOrder: 2 },
      { label: 'Terms and Conditions', href: '/terms-and-conditions', itemType: 'cms_page', policyType: 'terms', parentLabel: 'Policies', sortOrder: 3 },
      { label: 'Data Protection', href: '/data-protection-consent-policy', itemType: 'cms_page', policyType: 'data_protection', parentLabel: 'Policies', sortOrder: 4 },
      { label: 'Cookie Policy', href: '/cookie-policy', itemType: 'cms_page', policyType: 'cookie', parentLabel: 'Policies', sortOrder: 5 },
      { label: 'Refund Policy', href: '/refund-policy', itemType: 'cms_page', policyType: 'refund', parentLabel: 'Policies', sortOrder: 6 },
      { label: 'Return and Replacement', href: '/return-replacement-policy', itemType: 'cms_page', policyType: 'returns', parentLabel: 'Policies', sortOrder: 7 },
      { label: 'Cancellation Policy', href: '/cancellation-policy', itemType: 'cms_page', policyType: 'cancellation', parentLabel: 'Policies', sortOrder: 8 },
      { label: 'Shipping Policy', href: '/shipping-policy', itemType: 'cms_page', policyType: 'shipping', parentLabel: 'Policies', sortOrder: 9 },
      { label: 'Contact Us', href: '/contact', itemType: 'landing_anchor', sortOrder: 10 },
    ],
  },
];
